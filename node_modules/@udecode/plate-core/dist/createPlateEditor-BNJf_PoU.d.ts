...
import { Value, ENodeEntry, TElement, EElement, EText, EElementOrText, TText, TNodeEntry, TRange, TEditor, THistoryEditor, TDescendant, EDescendant, GetNodeEntriesOptions, TNode, NodeOf, QueryNodeOptions } from '@udecode/slate';
...
export { KEY_EVENT_EDITOR as $, createHistoryPlugin as A, KEY_INLINE_VOID as B, type CreatePlateEditorOptions as C, DefaultLeaf as D, ELEMENT_DEFAULT as E, withInlineVoid as F, GLOBAL_PLATE_SCOPE as G, createInlineVoidPlugin as H, withInsertData as I, KEY_INSERT_DATA as J, KEY_DESERIALIZE_AST as K, createInsertDataPlugin as L, type LengthPlugin as M, type NoInfer as N, type OverrideByKey as O, type PlateChangeKey as P, KEY_LENGTH as Q, type RenderElementFn as R, withLength as S, type TEditableProps as T, type UsePlateEditorStoreOptions as U, createLengthPlugin as V, type WithPlatePlugin as W, KEY_NODE_FACTORY as X, createNodeFactoryPlugin as Y, KEY_PREV_SELECTION as Z, createPrevSelectionPlugin as _, type PlateId as a, collapseWhiteSpace as a$, createEventEditorPlugin as a0, type EventEditorState as a1, eventEditorStore as a2, eventEditorActions as a3, eventEditorSelectors as a4, useEventEditorSelectors as a5, getEventPlateId as a6, useFocusEditorEvents as a7, CARRIAGE_RETURN as a8, LINE_FEED as a9, htmlStringToDOMNode as aA, htmlTextNodeToString as aB, inlineTagNames as aC, isHtmlBlockElement as aD, isHtmlComment as aE, isHtmlElement as aF, isHtmlFragmentHref as aG, isHtmlInlineElement as aH, isHtmlTable as aI, isHtmlText as aJ, isOlSymbol as aK, parseHtmlDocument as aL, parseHtmlElement as aM, pipeDeserializeHtmlElement as aN, pipeDeserializeHtmlLeaf as aO, pluginDeserializeHtml as aP, postCleanHtml as aQ, preCleanHtml as aR, removeHtmlNodesBetweenComments as aS, removeHtmlSurroundings as aT, replaceTagName as aU, traverseHtmlComments as aV, traverseHtmlElements as aW, traverseHtmlNode as aX, traverseHtmlTexts as aY, unwrapHtmlElement as aZ, collapseString as a_, NO_BREAK_SPACE as aa, SPACE as ab, TAB as ac, ZERO_WIDTH_SPACE as ad, KEY_DESERIALIZE_HTML as ae, createDeserializeHtmlPlugin as af, type DeserializeHtmlChildren as ag, type DeserializeHtmlNodeReturnType as ah, cleanHtmlBrElements as ai, cleanHtmlCrLf as aj, cleanHtmlEmptyElements as ak, cleanHtmlFontElements as al, cleanHtmlLinkElements as am, cleanHtmlTextNodes as an, copyBlockMarksToSpanChild as ao, deserializeHtml as ap, deserializeHtmlElement as aq, deserializeHtmlNode as ar, deserializeHtmlNodeChildren as as, findHtmlElement as at, someHtmlElement as au, getHtmlComments as av, htmlBodyToFragment as aw, htmlBrToNewLine as ax, htmlElementToElement as ay, htmlElementToLeaf as az, type PlateEditor as b, getPluginInjectProps as b$, collapseWhiteSpaceChildren as b0, collapseWhiteSpaceElement as b1, collapseWhiteSpaceNode as b2, collapseWhiteSpaceText as b3, inferWhiteSpaceRule as b4, isLastNonEmptyTextOfInlineFormattingContext as b5, upsertInlineFormattingContext as b6, endInlineFormattingContext as b7, type WhiteSpaceRule as b8, type TrimStartRule as b9, type TransformOptions as bA, type InjectProps as bB, type KeyboardHandler as bC, type KeyboardHandlerReturnType as bD, type OnChange as bE, type PluginOptions as bF, type PlatePluginComponent as bG, type PlatePluginInsertDataOptions as bH, type PlatePluginInsertData as bI, type PluginKey as bJ, type PlatePluginKey as bK, type PlatePluginProps as bL, type RenderAfterEditable as bM, type SerializeHtml as bN, type ToggleMarkPlugin as bO, type WithOverride as bP, type TRenderElementProps as bQ, type ApplyDeepToNodesOptions as bR, applyDeepToNodes as bS, createPluginFactory as bT, createPlugins as bU, flattenDeepPlugins as bV, type InjectedPlugin as bW, getInjectedPlugins as bX, getKeyByType as bY, getKeysByTypes as bZ, getPlugin as b_, type TrimEndRule as ba, type CollapseWhiteSpaceState as bb, resetEditor as bc, resetEditorChildren as bd, type ToggleNodeTypeOptions as be, toggleNodeType as bf, type PlateEditorMethods as bg, type PlateRenderElementProps as bh, type PlateRenderLeafProps as bi, type PlateRenderNodeProps as bj, type PlateStoreState as bk, EXPOSED_STORE_KEYS as bl, type Nullable as bm, DOM_HANDLERS as bn, type HandlerReturnType as bo, type KeyboardEventHandler as bp, type DOMHandlerReturnType as bq, type DOMHandler as br, type DOMHandlers as bs, type DecorateEntry as bt, type Decorate as bu, type DeserializeHtml as bv, type HotkeyPlugin as bw, type InjectComponentProps as bx, type InjectComponentReturnType as by, type InjectComponent as bz, type PlateProps as c, getPluginOptions as c0, getPluginType as c1, getPluginTypes as c2, getPlugins as c3, getPluginsByKey as c4, getRenderNodeProps as c5, mapInjectPropsToPlugin as c6, mergeDeepPlugins as c7, mergeDeepToNodes as c8, mockPlugin as c9, normalizeDescendantsToDocumentFragment as ca, normalizeInitialValue as cb, overridePluginsByKey as cc, pipeDecorate as cd, convertDomEventToSyntheticEvent as ce, isEventHandled as cf, pipeHandler as cg, pipeInjectProps as ch, pipeInsertDataQuery as ci, pipeInsertFragment as cj, pipeOnChange as ck, pipeTransformData as cl, pipeTransformFragment as cm, type GetInjectPropsOptions as cn, type GetInjectPropsReturnType as co, pluginInjectProps as cp, setDefaultPlugin as cq, createHotkey as cr, sharedHotkeys as cs, withHOC as ct, getSlateClass as cu, type PlatePlugin as d, type RenderElement as e, type RenderLeaf as f, Plate as g, type WithPlateOptions as h, PLATE_SCOPE as i, createPlateStore as j, PlateStoreProvider as k, usePlateEditorStore as l, usePlateSelectors as m, usePlateActions as n, usePlateStates as o, plateStore as p, usePlateId as q, createPlateEditor as r, createDeserializeAstPlugin as s, KEY_EDITOR_PROTOCOL as t, usePlateStore as u, withEditorProtocol as v, withPlate as w, createEditorProtocolPlugin as x, KEY_HISTORY as y, withTHistory as z };
